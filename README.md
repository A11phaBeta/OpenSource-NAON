...
---
#### 1. 매장고객 사용 Android Application UI / UX 디자인 (Android Application UI / UX design for store customers)   
...
#### 2. 점주 사용 Android Application UI / UX 디자인 (Android Application UI / UX design using store owner)      
